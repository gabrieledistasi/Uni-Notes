...
Il file dizionario.c raccoglie tutte le funzioni per la gestione del dizionario. La funzione main è contenuta nello stesso file.

Sono presenti inoltre i file lista.c e dizionario.h già visti in precedenza.
...
/*La funzione cancella_testa elimina ll nodo in testa alla lista di input, è definita nel file lista.c
...
/*Compilazione
Il programma è diviso i tre file: de definizioni dei tipi di dato sono sul file dizionario.h e le funzioni delle liste sono definite sul file lista.c. Per compilare il programma occorre compilare insieme dizionario.c e lista.c.
