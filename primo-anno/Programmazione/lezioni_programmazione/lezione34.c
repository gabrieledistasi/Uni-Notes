/*Dizionari
Un dizionario è implementato con un array di m liste concatenate. 
La lista contenente una coppia chiave-valore è stabilita da una funzione hash della chiave.*/
