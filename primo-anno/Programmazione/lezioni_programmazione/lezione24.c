...
/*Questa versione, rispetto a quella della scorsa lezione, utilizza il tipo di dato double al posto del float. 
Il tipo double codifica numeri in virgola mobile a precisione doppia e garantisce maggiore risoluzione e 
quindi approssimazioni più precise.
*/ 
