...
/*Definiamo un nuovo tipo di dato chiamato lista che implementa una struttura dati sequenziale 
contenente double sulla quale sono definite le operazioni di creazione di lista vuota, 
indicizzazione in lettura e scrittura, inserimento e cancellazione dalla coda.*/
