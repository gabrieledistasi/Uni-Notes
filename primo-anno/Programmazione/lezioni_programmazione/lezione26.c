...
/*Viene allocata memoria per un double e l'indirizzo assegnago ad a. 
Quest'ultimo può essere visto come un vettore di un elemento e, pertanto, accedere al double con l'indicizzazione.
