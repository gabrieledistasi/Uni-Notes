...
#che riceva una lista lst
#restituisce (start, end), tale che lst[start:end] sia la più lunga sottosequenza contigua di valori uguali
#in caso di parità restituisce la prima 
